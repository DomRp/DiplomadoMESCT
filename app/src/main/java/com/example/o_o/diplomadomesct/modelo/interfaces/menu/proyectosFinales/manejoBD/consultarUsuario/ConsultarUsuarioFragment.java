package com.example.o_o.diplomadomesct.modelo.interfaces.menu.proyectosFinales.manejoBD.consultarUsuario;
...
public class ConsultarUsuarioFragment extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //=========================================================================================
        ((MainActivity) getActivity()).setActionBarTitle("Consultar usuarios");
        //=========================================================================================
